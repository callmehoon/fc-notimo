...
class IndividualTemplateControllerTest {
    ...
    void getAllTemplates_200과_Page_JSON반환() throws Exception {
        ...
        given(individualTemplateService.getAllTemplates(anyInt(), any(Pageable.class)))
                .willReturn(page);
        ...
        verify(individualTemplateService).getAllTemplates(eq(1), any(Pageable.class));
    }
    ...
    void getAllTemplatesAsync_200과_Page_JSON반환() throws Exception {
        ...
        given(individualTemplateService.getAllTemplatesAsync(anyInt(), any(Pageable.class)))
        ...
        verify(individualTemplateService).getAllTemplatesAsync(eq(2), any(Pageable.class));
    }
