  ...
  return (
    <Box sx={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'auto' }}>
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100%', bgcolor: '#f0f2f5' }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2 }}>
          <Button variant="contained" color="primary" onClick={handleSave} fullWidth disabled={isPasswordFormInvalid && (newPassword || confirmNewPassword)}>
            저장
          </Button>
